...
@section('title', 'Создание видео')
@section('content')
<div class="bg-white rounded-lg shadow p-6 max-w-3xl mx-auto">
    <h2 class="text-2xl font-semibold mb-6">Создать новое видео</h2>

    <form action="{{ route('admin.videos.create') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <!-- Основные поля -->
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <input name="duration" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                </div>
