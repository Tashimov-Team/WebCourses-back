...
@section('title', 'Редактирование плана')
@section('content')
    ...
    <form action="" method="POST">
        ...
        <div class="grid grid-cols-1 gap-6">
            <div>
                ...
                <input value="{{ $curricula->title }}" name="title" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
            </div>

            <div class="grid grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Длительность (Часы)</label>
                    <input value="{{ $curricula->duration }}" name="duration" type="number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                </div>
            ...
            <div>
                ...
                <input value="{{ $curricula->themes }}" name="themes" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
            </div>
        </div>
